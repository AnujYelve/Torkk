  ...
  const timelineSteps = [
    {
      ...
      description:
        "BlackOriginX is established as a technology company focused on building innovative digital products and software ecosystems.",
      icon: Layers,
      align: "left",
    },
    {
      ...
      title: "Prime Venture",
      description:
        "Incubation and active development of Torkk, addressing connected telemetry systems and smart mobility integrations.",
      icon: Cpu,
      align: "right",
    },
    {
    ...
    <div className="pb-24 space-y-24">
      ...
      <section className="relative w-full min-h-[80vh] sm:min-h-[85vh] flex items-center justify-start py-20 px-6 sm:px-12 lg:px-20 text-left overflow-hidden bg-slate-100/50">
        ...
        <div className="relative z-20 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold text-[#1B1B1F] tracking-tight leading-[1.15] max-w-3xl">
            Moving Forward, <br />
          ...
          <p className="text-[#66687A] text-base sm:text-lg max-w-2xl leading-relaxed">
            Torkk isn't just about fine applications, it's a mission. The products we build, the connections we host, and the trust we earn every single day.
          </p>
      ...
      <div className="space-y-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <section id="story-promise" className="pt-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1B1B1F] leading-tight">
                Built on a simple promise: <br className="hidden sm:inline" />
                Better movement for everyone.
              </h2>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-[#66687A] text-sm leading-relaxed pt-2">
                <p>
                  Founded in a small garage in 2018, Torkk began with a single observation: urban mobility was broken. It was expensive, unreliable, and earned a bad reputation. Our founders envisioned a platform that prioritized safety, fair pricing, and trust above all else.
                </p>
                <p>
                  Today, we serve multi-tiered ecosystems connecting riders and drivers. Our core philosophy remains unchanged: We believe that every trip is an opportunity to improve someone's day and strengthen the fabric of local communities.
                </p>
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Our Mission */}
          <div className="bg-white p-8 sm:p-10 rounded-3xl border border-[#ECEAF4] shadow-[0_10px_30px_rgba(110,85,242,0.04)] hover:shadow-xl hover:shadow-[#3B36EA]/10 transition-all duration-300 space-y-4">
            ...
            <h3 className="text-2xl font-extrabold text-[#1B1B1F]">Our Mission</h3>
            <p className="text-[#66687A] text-sm leading-relaxed">
          ...
          {/* Our Vision */}
          <div className="bg-white p-8 sm:p-10 rounded-3xl border border-[#ECEAF4] shadow-[0_10px_30px_rgba(110,85,242,0.04)] hover:shadow-xl hover:shadow-[#6E55F2]/10 transition-all duration-300 space-y-4">
            ...
            <h3 className="text-2xl font-extrabold text-[#1B1B1F]">Our Vision</h3>
            <p className="text-[#66687A] text-sm leading-relaxed">
        ...
        <section className="space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-[#66687A] text-sm sm:text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreValues.map((val, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-white p-8 rounded-3xl border border-[#ECEAF4] shadow-[0_10px_30px_rgba(110,85,242,0.04)] hover:shadow-xl hover:shadow-[#3B36EA]/10 hover:-translate-y-1 transition-all duration-300 flex flex-col items-start space-y-4"
                >
                  ...
                  <h3 className="text-xl font-bold text-[#1B1B1F]">{val.title}</h3>
        ...
        {/* 5. Company Timeline Section (USING BRAND GRADIENT INSTEAD OF GOLD) */}
        <section className="space-y-16 pt-6">
          <div className="text-center space-y-3">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1B1B1F] tracking-tight">
              Company Timeline
            </h2>
              ...
              {timelineSteps.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Left Box */}
                    <div
                      className={`w-full md:w-[45%] ${isLeft
                        ? "md:text-right text-center md:pr-8"
                        : "hidden md:block"
                        }`}
                    >
                      {isLeft && (
                    ...
                    {/* Center Node Icon (Brand Gradient Ring) */}
                    ...
                    <div
                      className={`w-full md:w-[45%] ${!isLeft
                        ? "md:text-left text-center md:pl-8"
                        : "block md:hidden"
                        }`}
                    >
                      {!isLeft && (
        ...
        {/* 6. Leadership Section (MATCHING USER'S PHOTO DESIGN EXACTLY) */}
        <section className="space-y-10 pt-4">
          <div className="text-center space-y-2">
            <span className="text-xs font-extrabold uppercase tracking-widest text-[#3B36EA]">
              ECOSYSTEM ADVISORY
            </span>
            <h2 className="text-4xl sm:text-5xl font-extrabold text-[#1B1B1F] tracking-tight">
              Our Leadership
            </h2>
            <div className="w-20 h-1.5 bg-gradient-to-r from-[#3B36EA] via-[#6E55F2] to-[#C24D2E] rounded-full mx-auto mt-2" />
          </div>
            ...
            {leaders.map((leader, idx) => (
              ...
              >
                <div className="space-y-3">
                  <h3 className="text-2xl font-extrabold text-[#1B1B1F] tracking-tight">
                    {leader.name}
                  </h3>
                  <div className="text-xs font-extrabold uppercase tracking-widest text-[#3B36EA]">
                    {leader.role}
                  </div>
                  <p className="text-xs sm:text-sm text-[#66687A] leading-relaxed pt-2">
                    {leader.bio}
                  </p>
                </div>

                {/* Card Footer Icons */}
                <div className="pt-4 border-t border-[#ECEAF4]/80 flex items-center gap-4 text-[#9895B3]">
                  <a
                    href="#linkedin"
                    aria-label="LinkedIn"
                    className="hover:text-[#3B36EA] transition-colors"
                  >
        ...
        <section>
          <div className="bg-gradient-to-r from-[#3B36EA] via-[#6E55F2] to-[#7B52F2] rounded-[36px] p-8 sm:p-14 text-white text-center space-y-6 shadow-xl shadow-[#3B36EA]/20 relative overflow-hidden">
            ...
            <p className="text-white/90 text-sm sm:text-base max-w-xl mx-auto leading-relaxed relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2 relative z-10">
              ...
              <Link
                href="/careers"
                className="px-8 py-3.5 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white font-bold text-sm hover:bg-white/30 transition-all"
              >
                View Open Roles
              </Link>
            </div>
